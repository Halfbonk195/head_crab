...
class BlueSkyWithStars:
    ...
    def _create_stars(self):
        ...
        available_space_x = self.settings.screen_width - 10
        number_stars_x = available_space_x // (0.6 * star_width)
        ...
        number_rows = available_space_y // (0.6 * star_height)
